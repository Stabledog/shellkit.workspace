...
shellkit-aws unk ${Artprod}/dpkg-python-development-base:3.11 # For publishing to AWS S3
...
shellkit-bashup ubuntu:focal $Artprod/rhel7-dpkg-scratch-builder:latest # For shellkit bash functional tests
EOF
}
